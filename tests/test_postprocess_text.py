def test_polish_text_fields_cleans_boilerplate_and_spacing():
        ...
        "actions": [
            {
                "name": "Tail",
                "description": [
                    "Hit:10 (2d6 + 5) bludgeoning. The dragon can take three legendary actions at the end of another creature's turn."
                ],
            }
        ],
        "legendary_actions": [
            {"name": "Wing Attack.", "description": ["H it:10 (2d6 + 5) damage."]}
        ],
    }
    ...
    assert "2d6 + 5" in " ".join(polished["legendary_actions"][0]["description"])
