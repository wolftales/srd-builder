...
SRD-Builder extracts structured JSON datasets from the SRD 5.1 PDF. The v0.39.1 build ships **16 datasets** containing **1,693 items**:
...
| `equipment.json` | 259 | v2.3.0 | Weapons, armor, adventuring gear |
...
| `monsters.json` | 317 | v2.1.0 | Monsters, creatures, and NPCs |
