...
Source: SRD pages 64-65 (Weapon Properties section in Equipment chapter)
"""
...
# The 10 D&D 5e weapon properties from SRD pages 64-65
...
def parse_weapon_properties(ruleset: str) -> list[dict]:
    ...
    Note:
        ...
        Descriptions are from SRD Equipment chapter (pages 64-65).
    """
    return stamp_source(WEAPON_PROPERTIES_DATA, ruleset)
