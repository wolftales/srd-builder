...
# ═══════════════════════════════════════════════════════════════════════════
# font_stateful_walk — header + ordered span rules + intra-record state machine
# ═══════════════════════════════════════════════════════════════════════════
#
# Sibling pattern to font_fingerprint_walk. Used when a record's body is not a
# uniform stream of spans routed by font alone, but rather a small state
# machine: certain text triggers (e.g. "Duration:" appearing in the header
# bucket) transition the record from one sub-section to the next, and
# different fonts produce differently-tagged spans within the same record.
