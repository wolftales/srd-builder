...
def add_ability_modifiers(monster: dict[str, Any]) -> dict[str, Any]:
    ...
    NOTE: As of schema v2.0.0, ability scores are nested {value, modifier} objects
    generated by the parser. This function is now a no-op pass-through for
    backward compatibility in the postprocessing pipeline.
    """
    # Parser now generates nested {value, modifier} format directly
    # This function maintained for pipeline compatibility
    return monster
