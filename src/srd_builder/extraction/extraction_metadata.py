...
PATTERN_TYPES = {
    ...
    "prose_section": "Named prose sections with header detection (conditions, diseases, item descriptions)",
...
TABLES: dict[str, dict[str, Any]] = {
    ...
    # ═══════════════════════════════════════════════════════════
    # DMG TABLES - Chapter 8: Running the Game
    # ═══════════════════════════════════════════════════════════
    "poisons": {
        "pattern_type": "split_column",
        "source": "srd",
        "pages": [204],
        "headers": ["Item", "Type", "Price per Dose"],
        "regions": [
            {
                "x_min": 57,
                "x_max": 240,
                ...
                "column_boundaries": [
                    83,
                    143,
                ],  # Relative to x_min: Item (<83), Type (83-143), Price (>143)
            },
        ],
        "chapter": "Chapter 8: Running the Game",
        "data_driven": True,
        "confirmed": False,
        "validation": {"expected_rows": 14},
        "notes": "Poison reference table. Boundaries relative to x_min=57.",
    },
    "short_term_madness": {
        "pattern_type": "split_column",
        "source": "srd",
        "pages": [201],
        "headers": ["d100", "Effect (lasts 1d10 minutes)"],
        "regions": [
            {
                "x_min": 52,
                "x_max": 300,
            ...
            },
            {
                ...
                "y_min": 71,
                "y_max": 195,
                "column_boundaries": [365],
            },
        ],
        "chapter": "Chapter 8: Running the Game",
        "data_driven": True,
        "confirmed": False,
        "validation": {"expected_rows": 10},
        "notes": "Short-Term Madness table spanning two columns on page 201",
    },
    "long_term_madness": {
        "pattern_type": "split_column",
        "source": "srd",
        "pages": [201],
        "headers": ["d100", "Effect (lasts 1d10 × 10 hours)"],
        "regions": [
            {
                "x_min": 320,
                "x_max": 560,
        ...
        "data_driven": True,
        "confirmed": False,
        "validation": {"expected_rows": 12},
        "notes": "Long-Term Madness random effects table (right column page 201, 12 uneven entries). D100 at x=332, effect text starts at x=369.",
    },
    "indefinite_madness": {
        "pattern_type": "split_column",
        "source": "srd",
        "pages": [202],
        "headers": ["d100", "Flaw (lasts until cured)"],
        "regions": [
            {
                "x_min": 52,
                "x_max": 300,
        ...
        "confirmed": False,
        "validation": {"expected_rows": 12},
        "notes": "Indefinite Madness random flaw table (page 202). Last d100 range at y=353, stopping at y=360.",
    },
    ...
    # ═══════════════════════════════════════════════════════════
    # PROSE DATASETS - Named sections with prose descriptions
    # ═══════════════════════════════════════════════════════════
    "conditions": {
        ...
        "chapter": "Appendix PH-A: Conditions",
        "data_driven": True,
        "confirmed": True,
    },
    "diseases": {
        ...
        "schema_version": "1.4.0",
        "description": "Diseases with transmission, effects, and recovery mechanics",
        "output_key": "diseases",
        "entity_type": "disease",
        "chapter": "Chapter 8: Running the Game",
        "data_driven": True,
    ...
    "poison_descriptions": {
        ...
        "schema_version": "1.4.0",
        "description": "Poison prose descriptions with effects and mechanics",
        "output_key": "poison_descriptions",
        "entity_type": "poison_description",
        "chapter": "Chapter 8: Running the Game",
        "data_driven": True,
        "confirmed": False,
        "notes": "Prose descriptions for each poison. The reference table with Type/Price is separate.",
    },
    # Madness and poisons TABLE are configured under table extraction section above
    "equipment_descriptions": {
        "pattern_type": "prose_section",
        "source": "srd",
        "pages": [66, 68],
        "known_headers": [],  # Dynamic discovery - item names from PDF
        "schema_version": "1.4.0",
        "description": "Equipment item prose descriptions with mechanical rules",
        "output_key": "equipment_descriptions",
        "entity_type": "equipment_description",
        "chapter": "Chapter 5: Equipment",
        "data_driven": True,
        "confirmed": False,
    },
