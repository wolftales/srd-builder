...
POISON_DESCRIPTIONS = {
    "assassin's_blood": {  # Note: Uses fancy apostrophe from PDF
        ...
        "damage": {"average": 6, "formula": "1d12", "type": "poison"},
    },
    "burnt_othur_fumes": {
        ...
        "damage": {"average": 10, "formula": "3d6", "type": "poison"},
    },
    "crawler_mucus": {
    ...
    "midnight_tears": {
        ...
        "damage": {"average": 31, "formula": "9d6", "type": "poison"},
    },
    "oil_of_taggit": {
    ...
    "pale_tincture": {
        ...
        "damage": {"average": 3, "formula": "1d6", "type": "poison"},
    },
    "purple_worm_poison": {
        ...
        "damage": {"average": 42, "formula": "12d6", "type": "poison"},
    },
    "serpent_venom": {
    ...
    "wyvern_poison": {
        ...
        "save": {"dc": 15, "ability": "constitution"},
        "damage": {"average": 24, "formula": "7d6", "type": "poison"},
    },
}
