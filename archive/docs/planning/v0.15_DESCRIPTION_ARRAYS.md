# Planning: v0.15.x Description Arrays

**Status:** ✅ Complete (v0.15.1 spells, v0.15.2 monsters)
**Date:** December 21, 2025
**Scope:** Font metadata extraction, paragraph segmentation, text cleaning
...
- Extracted font metadata for all spell text blocks
- New structure: `header_blocks` and `description_blocks` arrays
- Each block includes: text, font, size, is_bold, is_italic, is_field_label
- Parser updated to reconstruct text from blocks
- All 173 tests passing
- 319 spells parsing correctly
- Commit: 203f8aa "feat: Phase 1 - Extract font metadata for spells"

**Phase 2: IN PROGRESS**
- Starting complexity reduction...
...
**Actual (Phase 1):** ~30 minutes
- Investigation script: 10 min
