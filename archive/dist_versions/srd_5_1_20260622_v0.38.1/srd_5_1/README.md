...
**Builder version:** srd-builder v0.38.1
**Ruleset:** SRD 5.1 (System Reference Document)
**Generated:** (reproducible build)
**Total items:** 1687 across 16 datasets
...
| Conditions | 15 | `conditions.json` | v3.0.0 |
| Damage Types | 13 | `damage_types.json` | v1.1.0 |
| Diseases | 3 | `diseases.json` | v3.0.0 |
| Equipment | 259 | `equipment.json` | v2.3.0 |
| Features | 245 | `features.json` | v4.0.0 |
| Lineages | 13 | `lineages.json` | v2.0.0 |
| Magic Items | 240 | `magic_items.json` | v2.0.0 |
| Monsters | 317 | `monsters.json` | v2.1.0 |
| Poisons | 14 | `poisons.json` | v2.1.0 |
| Rules | 167 | `rules.json` | v3.1.0 |
| Skills | 18 | `skills.json` | v1.0.0 |
| Spells | 319 | `spells.json` | v2.0.0 |
| Tables | 35 | `tables.json` | v3.1.0 |
...
- `condition.schema.json` — v3.0.0
- `damage_type.schema.json` — v1.1.0
- `disease.schema.json` — v3.0.0
- `equipment.schema.json` — v2.3.0
- `features.schema.json` — v4.0.0
- `lineage.schema.json` — v2.0.0
- `magic_item.schema.json` — v2.0.0
- `monster.schema.json` — v2.1.0
- `poison.schema.json` — v2.1.0
- `rule.schema.json` — v3.1.0
- `skill.schema.json` — v1.0.0
- `spell.schema.json` — v2.0.0
- `table.schema.json` — v3.1.0
